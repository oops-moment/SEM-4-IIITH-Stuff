...
const CommonComponentNOnMODnj = () => {
  ...
  const handleFollow = async (userjiskofollowkrna) => {
    try {
      ...
      console.error("Error:", error);
      alert(error.response.data.error); // show the error message returned from the server
    }
  };
...
<ProfileIcon fontSize="large" />
      ...
      >
        You haven't joined so can't  post !
...
export default CommonComponentNOnMODnj;
